"""
Django settings for sparkling_truth_44019 project.
...
ROOT_URLCONF = 'sparkling_truth_44019.urls'
...
WSGI_APPLICATION = 'sparkling_truth_44019.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sparkling_truth_44019 API",
    "DESCRIPTION": "API documentation for sparkling_truth_44019 App",
    "VERSION": "v1",
}
